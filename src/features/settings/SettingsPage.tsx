...
export function SettingsPage() {
  ...
  const handleReconnect = async (connectedWallet?: ConnectedWalletSnapshot) => {
    ...
    try {
      ...
      let walletSnapshot = connectedWallet;
      let effectiveWallet = walletSnapshot?.address ?? walletAddress;
      try {
        if (
          !walletSnapshot &&
          ...
          if (!connectedAddress || !result?.signMessage) {
            throw new Error(
          ...
          effectiveWallet = connectedAddress;
        }
      } catch (connectErr) {
                      ...
                      <div className="space-y-2">
                        ...
                        {walletProvider === 'thirdweb' ? (
                          <ThirdwebConnectButton
                            ...
                            className="w-full"
                            onConnected={(address, chainId, signMessageOverride) => {
                              if (!isReconnecting) {
                                void handleReconnect({
                                  address,
                                  chainId,
