...
export function InboxSwitcher() {
  ...
  const preferredIdentityLabel =
    identityDisplayName && !isAutoGeneratedDisplayName(identityDisplayName) ? identityDisplayName : undefined;
  ...
  const handleSyncProfile = async () => {
    ...
    try {
      ...
      if (profile && (profile.displayName || profile.avatarUrl)) {
        ...
        if (
          profile.displayName &&
          isAutoGeneratedDisplayName(identity.displayName) &&
  ...
  const handleCreateLocalAppKey = async () => {
    try {
      ...
      alert(formatCreateInboxError(e));
    }
  };
