...
export function Layout() {
  ...
  const dispatchInviteNotice = useCallback(
    (request: InviteRequest, suffix: string, body: string) => {
      ...
      void dispatchXmtpDurableSideEffect({
        type: 'system',
        detail: {
            conversationId: request.conversationId,
            ownerInboxId: identity?.inboxId,
            system: {
              id: noticeId,
  ...
  // Keep the hidden compatibility registry aligned with the active profile so
  // recovery/migration tools do not retain a stale label.
  useEffect(() => {
    ...
    const handleIncomingMessage = async ({
      ...
      try {
        ...
        if (!conversation) {
          ...
          console.log('[Layout] ✅ New conversation created:', conversationId);
